...
public class Bullet {
   ...
   public static Entity createRocket(Vector2 position, Vector2 velocity, float rotation) {
      ...
      Enigne.createEngine(e, -0.17f, 0.05f, -90f, 0.2f, Directions.getDirections(false, false, false, false, true, false), 0.4f);
      Enigne.createEngine(e, -0.2f, 0f, 0f, 3.0f, Directions.getDirections(true, false, false, false, false, false), 0.4f);
